...
<div id="cat_childset_${obj.name}_${childset_index}">
	...
	<table><tr><th>Type</th><th>Description</th><th>Sample Instances</th></tr>
	<#list childset as child>
	<tr>
		<td><input type="radio" name="cat_radio_${obj.name}_${childset_index}" value="cat_${child}">&nbsp;<span class="cat-option-text" id="cat_${child}">${child}</span></td>
